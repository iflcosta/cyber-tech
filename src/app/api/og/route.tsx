    ...
    try {
            ...
            return new ImageResponse(
                <div style={{ width: 1200, height: 630, backgroundColor: BG, display: 'flex', position: 'relative', overflow: 'hidden' }}>
                    ...
                    <div style={{ position: 'absolute', top: 0, right: 0, width: 720, height: 630, display: 'flex' }}>
                        ...
                        {/* Left fade */}
                        <div style={{ position: 'absolute', top: 0, left: 0, bottom: 0, width: 420, backgroundImage: `linear-gradient(to right, ${BG} 0%, rgba(13,13,17,0.8) 60%, transparent 100%)`, display: 'flex' }} />
                        {/* Bottom fade */}
                        <div style={{ position: 'absolute', bottom: 0, left: 0, right: 0, height: 200, backgroundImage: `linear-gradient(to top, ${BG} 0%, transparent 100%)`, display: 'flex' }} />
                    </div>
        ...
        return new ImageResponse(
            <div style={{ width: 1200, height: 630, backgroundColor: BG, display: 'flex', position: 'relative', overflow: 'hidden' }}>
                ...
                <div style={{ position: 'absolute', top: 0, right: 0, width: 660, height: 630, display: 'flex' }}>
                    <img src={BG_IMAGE} alt="" style={{ width: 660, height: 630, objectFit: 'cover', opacity: 0.7 }} />
                    <div style={{ position: 'absolute', top: 0, left: 0, bottom: 0, width: 400, backgroundImage: `linear-gradient(to right, ${BG} 0%, rgba(13,13,17,0.85) 55%, transparent 100%)`, display: 'flex' }} />
                    <div style={{ position: 'absolute', bottom: 0, left: 0, right: 0, height: 180, backgroundImage: `linear-gradient(to top, ${BG} 0%, transparent 100%)`, display: 'flex' }} />
                </div>

                <div style={{ position: 'absolute', bottom: -180, left: -60, width: 700, height: 700, borderRadius: 350, backgroundImage: `radial-gradient(circle, rgba(229,57,53,0.12) 0%, transparent 65%)`, display: 'flex' }} />
                ...
                <div style={{ position: 'absolute', top: 0, left: 0, right: 0, bottom: 0, padding: 80, display: 'flex', flexDirection: 'column', justifyContent: 'space-between' }}>
                    ...
                    <div style={{ display: 'flex', flexDirection: 'column', maxWidth: '65%', paddingLeft: 44, position: 'relative', gap: 16 }}>
                        <div style={{ position: 'absolute', left: 0, top: 0, bottom: 0, width: 6, backgroundColor: RED, display: 'flex' }} />
                        {category && (
                    ...
                    {/* Bottom */}
                    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-end', borderTopWidth: 1, borderTopStyle: 'solid', borderTopColor: 'rgba(255,255,255,0.1)', paddingTop: 32 }}>
                        {tagRow}
                        {urlBlock}
                    </div>
                </div>
