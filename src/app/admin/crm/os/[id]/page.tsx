  ...
  try {
    ...
    return (
      <div className="mx-auto max-w-2xl p-6">
        <h1 className="text-2xl font-bold text-red-700">Erro ao carregar OS</h1>
        <p className="mt-2 text-slate-700">
          Stack trace abaixo (debug temporário, removido em seguida):
        </p>
        <pre className="mt-4 overflow-auto rounded-md bg-slate-900 p-4 text-xs text-slate-100">
          {message}
        </pre>
        <Link href="/admin/crm/os" className="mt-4 inline-block text-blue-600 hover:underline">
          ← Voltar para a lista
        </Link>
      </div>
    );
