  ...
  return (
    <>
      ...
      <main className="min-h-screen bg-white text-zinc-950 font-sans antialiased">
        ...
        {/* (Fusão das antigas seções #servicos, #estrutura e #orcamento sem repetição)*/}
        {/* ========================================================================= */}
        <section id="servicos" className="py-16 sm:py-20 bg-zinc-100 border-b border-zinc-300">
          <div id="estrutura" className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-6 pb-8 border-b-2 border-zinc-950 mb-8">
              <div>
              ...
              <p className="text-xs sm:text-sm text-zinc-600 max-w-md leading-relaxed">
                Cada andar da nossa loja no Centro de Bragança Paulista conta com bancada própria e especialistas residentes. Escolha o setor abaixo para falar direto no WhatsApp:
              </p>
            </div>

            {/* Grid Arquitetônico de 2 Colunas: 1º Andar (Térreo) vs. 2º Andar (Mezanino) */}
            <div id="orcamento" className="grid grid-cols-1 lg:grid-cols-2 border-2 border-zinc-950 divide-y lg:divide-y-0 lg:divide-x-2 divide-zinc-950 bg-white">
              {/* COLUNA 01: 1º ANDAR (TÉRREO) */}
              <div className="p-6 sm:p-8 flex flex-col justify-between">
                <div>
                  <div className="flex items-center justify-between font-mono text-xs pb-4 mb-5 border-b border-zinc-200">
                  ...
                  <div className="divide-y divide-zinc-200 border-y border-zinc-200 mb-6">
                    <div className="py-3.5 flex items-start justify-between gap-4">
                      <div>
                        <strong className="text-sm font-extrabold text-zinc-950 block">
                ...
                <div className="flex flex-col sm:flex-row gap-2.5">
                  <TrackedWhatsAppLink
                    ...
                    className="flex-1 inline-flex items-center justify-center gap-2 bg-zinc-950 hover:bg-zinc-800 text-white font-mono font-bold uppercase tracking-wider py-3.5 px-4 text-xs transition-colors"
                  >
                  ...
                  <TrackedWhatsAppLink
                    ...
                    className="inline-flex items-center justify-center gap-1.5 border border-zinc-900 bg-white hover:bg-zinc-100 text-zinc-950 font-mono font-bold uppercase tracking-wider py-3.5 px-4 text-xs transition-colors"
                  >
              ...
              <div className="p-6 sm:p-8 bg-[#09090b] text-white flex flex-col justify-between">
                <div>
                  <div className="flex items-center justify-between font-mono text-xs pb-4 mb-5 border-b border-zinc-800">
                  ...
                  <div className="divide-y divide-zinc-800 border-y border-zinc-800 mb-6">
                    <div className="py-3.5 flex items-start justify-between gap-4">
                      <div>
                    ...
                    <div className="py-3.5 flex items-start justify-between gap-4">
                      <div>
                        <strong className="text-sm font-extrabold text-white block">
                          02. Troca só do Vidro de Celular (Salve sua Tela Original)
                        </strong>
                        <span className="text-xs text-zinc-400 block mt-0.5">
                    ...
                    <div className="py-3.5 flex items-start justify-between gap-4">
                      <div>
                        <strong className="text-sm font-extrabold text-white block">
                          03. Parceria B2B para Lojistas & Assistências da Região
                        </strong>
                        <span className="text-xs text-zinc-400 block mt-0.5">
                ...
                <div className="flex flex-col sm:flex-row gap-2.5">
                  <TrackedWhatsAppLink
                    ...
                    className="flex-1 inline-flex items-center justify-center gap-2 bg-white hover:bg-zinc-200 text-black font-mono font-bold uppercase tracking-wider py-3.5 px-4 text-xs transition-colors"
                  >
                  ...
                  <a
                    ...
                    className="inline-flex items-center justify-center gap-1.5 border border-zinc-700 bg-zinc-900 hover:bg-zinc-800 text-white font-mono font-bold uppercase tracking-wider py-3.5 px-4 text-xs transition-colors"
                  >
        ...
        {/* ========================================================================= */}
        <section id="localizacao" className="py-16 sm:py-20 bg-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="border-2 border-zinc-950 bg-white">
              {/* Faixa Superior Compacta de Garantias (3 Pilares em 1 Linha) */}
