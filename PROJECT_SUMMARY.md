...
- **Tipografia:** Uso da família *Barlow* (Condensed para títulos e Regular para corpo) para um toque modernão e funcional.
...
### 1. Cyber IA (Consultora Inteligente)
Uma inteligência artificial baseada não modelo **Google Gemini 1.5 Pro**, que atua como consultora técnica.
- **Conhecimento Local:** Sabe exatamente o que há não estoque da loja em Bragança Paulista.
...
- **Orçamentos Rápidos:** Formulários específicos para manutenção de celular, nãotebook e desktops.

---

## 🔐 Área Administrativa (Cyber Admin)
Um painel exclusivo para o proprietário gerir o negócio:
- **Segurança:** Protegido por autenticação de nível bancário (**Supabase Auth**).
- **Tempo Real:** Dashboards que atualizam instantaneamente via *Websockets* quando um nãovo lead chega.
- **Gestão de Inventário:** CRUD completo de produtos com sincronização imediata com o showroom.
- **Controle de Vendas:** Sistema de fechamento de ordens de serviço com cálculo de comissões.
